...
public class GameUI : MonoBehaviour
{
    ...
    void Awake()
    {
        EnsureCanvasScaler();
        EnsureEmoteWheel();
        ThrowerReticleUI.EnsureExists();
        BallSelectUI.EnsureExists();
    ...
    void UpdateHud()
    {
        ...
        // Eski TMP "+" yerine ThrowerReticleUI kullanilir.
        if (crosshairText != null) crosshairText.gameObject.SetActive(false);
    ...
    void ApplyStyles()
    {
        ...
        // Legacy crosshair gizlenir; yeni reticle ThrowerReticleUI.
        if (crosshairText != null)
        {
