...
public class RoleZoneLimiter : MonoBehaviour
{
    ...
    private Collider homeThrowerZone;

    public Collider HomeThrowerZone => homeThrowerZone;
    ...
    void LateUpdate()
    {
        ...
        {
            KeepInsideHomeThrowerZone();
        }
    }

    void ResolveHomeThrowerZone()
    {
        ...
        homeThrowerZone = GetClosestThrowerZone();
    }
    ...
    void KeepInsideHomeThrowerZone()
    {
        if (homeThrowerZone == null)
        {
            ResolveHomeThrowerZone();
        }
        ...
        if (homeThrowerZone != null)
        {
            KeepInsideSingleZone(homeThrowerZone);
            return;
        }

        // Fallback: en yakin thrower bolgesi.
        ...
        KeepInsideSingleZone(GetClosestThrowerZone());
    }
